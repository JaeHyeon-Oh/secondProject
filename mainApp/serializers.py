...
from .models import CustomUser,mainDirectory,subDirectory,detailDirectory,Service,Banner,Icon,StickyBanner,Content,\
    VideoReview,Video
...
class detailDirectorySerializer(serializers.ModelSerializer):
    parent_id = serializers.CharField(source='sub_directory.sub_directory_id')
    class Meta:
...
class ServiceSerializer(serializers.ModelSerializer):
    parent_id = serializers.CharField(source='detail_directory.detail_directory_id')
    class Meta:
        model = Service
        fields = ( '__all__')
