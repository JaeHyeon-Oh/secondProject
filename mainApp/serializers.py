...
class PopularExpertSrializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Expert
        fields = ['expert_id', 'company_name','sub_name', 'is_connect', 'expert_description','price_sum','profile_image','expert','service']
        # depth=2
# #상세분야
...
class SearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['product_id','product_name','heart_count','rating_avg','review_count','created_at', 'image_url','Service','expert']
        # fields= ( '__all__')
        # depth=3
