    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Service', to='mainApp.service')),
                ('expert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expert', to='mainApp.expert')),
            ],
        ),
        migrations.AddIndex(
