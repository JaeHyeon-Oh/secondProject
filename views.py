...
from .models import mainDirectory,CustomUser,subDirectory,detailDirectory,Service,StickyBanner,Banner,Icon,Content,VideoReview
...
class StickyBannerList(APIView):
    ...
    def get(self, request):
        ...
        serializer = StickyBannerSerializer(stickyBanners)
